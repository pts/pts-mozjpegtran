...
${PREFIX}x86_64-apple-darwin14-gcc -o mozjpegtran.darwinc64 -mmacosx-version-min=10.5 -Wl,-dead_strip -ffunction-sections -fdata-sections -lSystem -lcrt1.10.5.o -nostdlib -O2 -W -Wall -Wno-unused-parameter $SRCS_3_0
