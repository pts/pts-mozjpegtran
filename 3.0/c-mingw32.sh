...
i686-w64-mingw32-gcc -o mozjpegtran.exe -m32 -mconsole -march=i686 -s -O2 -W -Wall -Wno-unused-parameter -Wl,--gc-sections -ffunction-sections -fdata-sections $SRCS_3_0
