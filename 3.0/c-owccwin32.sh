...
owcc -o mozjpegtran.ow.exe -bwin32 -fo=.oo -s -Os -fno-stack-check -fsigned-char -march=i386 -Wl,option -Wl,eliminate -Wl,runtime -Wl,console=3.10 -W -Wall -Wextra -Wno-n202 -Wno-n303 -Wno-n136 -Wno-n201 $SRCS_3_0 nouser32.c
rm -f ./*.oo
