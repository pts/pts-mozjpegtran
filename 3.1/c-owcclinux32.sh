...
owcc -o mozjpegtran.ow -blinux -s -fo=.oo -Os -fno-stack-check -fsigned-char -march=i386 -Wl,option -Wl,eliminate -W -Wall -Wextra -Wno-n202 -Wno-n303 -Wno-n136 -Wno-n201 $SRCS_3_1
rm -f ./*.oo
